 <aside class="sidenav navbar navbar-vertical navbar-expand-xs bg-white border-0 border-radius-xl my-3 fixed-start ms-2 " style="overflow-y: hidden;" id="sidenav-main">
  <hr class="horizontal dark mt-0">
  <div class="container-fluid w-auto">
    <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
    <a href="/" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
      <img src="home.svg" alt="Gambar SVG"  width="24" height="24" role="img">
    ...
    {{-- <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('data-patient') ? 'active' : '') }} " href="{{ url('data-patient') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item pb-2">
          <a class="nav-link {{ (Request::is('data-dokter') ? 'active' : '') }}" href="{{ url('data-dokter') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g id="Rounded-Icons" transform="translate(-1717.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
        ...
        <li class="nav-item pb-2">
          <a class="nav-link {{ (Request::is('treatment') ? 'active' : '') }}" href="{{ url('treatment') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('treatment') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
