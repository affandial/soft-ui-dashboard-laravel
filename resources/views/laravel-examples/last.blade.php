                ...
                <div class="card mb-4 mx-4">
                    ...
                    <div class="card-header pb-0 pt-0">
                        <div class="d-flex flex-row ">
                            ...
                            <a href="{{ url('today') }}">
                                <span
                                    class="badge badge-sm bg-gradient-light btn-outline-secondary">Hari Ini</span></a>&nbsp;
                                    <span class="badge badge-sm bg-gradient-secondary">Kemarin</span>&nbsp;
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $treat)
                                        <tr>
                                            ...
                                            <td class='ps-4'>
                                                <p class="text-xs font-weight-bold mb-0">{{ $treat->status }}
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                @if ($treat->status == 'pending')
                                                    <form
                                                        ...
                                                        @method('PUT')
                                                        <button type="submit"
                                                            style="padding: 0;border: none;background: none;" title="Batalkan Jadwal">
